...
const formElements = [
    {varName: 'name', id: 0, type: 'text', label: 'Departman İsmi', required: true},
...
export default () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            ...
            dispatch(createDepartment({newDepartment: newDepartment, placeId: placeId, userId: userId}));
    ...
    return (
        <div className={classes.root}>
            <Title text="Departman Kayıt Formu" />
            <form 
