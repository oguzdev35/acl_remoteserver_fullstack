...
function getSteps() {
    return ['Departmanın Yetkilendirileceği Kapıları Seçiniz', 'Tarih Belirleyiniz', 'Saat Belirleyiniz'];
}
  
function getStepContent(step, departmentId, places, rulePayload, setRulePayload) {
    ...
    React.useEffect( () => {
        dispatch(listBlock({
            placeId: places.find(({departments}) => departments.includes(departmentId))._id,
...
function VerticalLinearStepper(props) {
    ...
    return (
      <Dialog
        ...
        onClose={handleClose}
      >
        <DialogTitle id="department-auth-stepper">Departman Kapı Yetkilendirme</DialogTitle>
        <DialogContent>
            <Stepper activeStep={activeStep} orientation="vertical">
                {steps.map((label, index) => (
                    ...
                    <StepContent>
                        {getStepContent(index, departmentId, places, rulePayload, setRulePayload)}
