...
export default () => {
    ...
    const emptyRows = rowsPerPage - Math.min(rowsPerPage, departments.length - page * rowsPerPage);
            ...
            <Table className={classes.table}>
                ...
                <TableBody>
                    {(rowsPerPage > 0
                        ...
                        <TableRow key={department._id} hover={true}>
                ...
                <TableFooter>
                    <TableRow>
                        <TablePagination
                            labelRowsPerPage="Sayfa Başına Departman Sayısı"
